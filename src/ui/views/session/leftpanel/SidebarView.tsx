  ...
  return (
    <div className="SidebarView flex flex-column">
      <div className="SidebarView__scrollable grow flex flex-column items-center">
        <IconButton label="Home" variant="secondary" iconSrc={HomeIC} isCircle onClick={() => false} />
        <IconButton label="Grid" variant="secondary" iconSrc={GridIC} isCircle onClick={() => false} />
        <IconButton label="Create space" iconSrc={AddIC} isCircle onClick={() => false} />
        <IconButton label="Search" iconSrc={SearchIC} isCircle onClick={() => false} />
      </div>
      <div className="SidebarView__sticky flex flex-column items-center">
        <Avatar isCircle name={vm.userId} bgColor="var(--bg-primary-active)" />
      </div>
    </div>
  );
}
