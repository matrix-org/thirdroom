...
var ScriptingRuntimeModule = (() => {
  var _scriptDir = import.meta.url;
  
  return (
function(ScriptingRuntimeModule) {
  ScriptingRuntimeModule = ScriptingRuntimeModule || {};
...
var Module = typeof ScriptingRuntimeModule != 'undefined' ? ScriptingRuntimeModule : {};
...
["_runJS","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'scripting-runtime.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('scripting-runtime.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _runJS = Module["_runJS"] = createExportWrapper("runJS");
...
run();
  ...
  return ScriptingRuntimeModule.ready
}
);
})();
export default ScriptingRuntimeModule;