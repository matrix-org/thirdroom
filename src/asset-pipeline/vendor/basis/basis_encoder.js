var BASIS = (function () {
  ...
  return function (BASIS) {
    ...
    var wasmMemory;
    var wasmTable = new WebAssembly.Table({ initial: 325, maximum: 325 + 0, element: "anyfunc" });
    var ABORT = false;
    var EXITSTATUS = 0;
    ...
    var dynCall_iiiiiiiiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiiiiiiiii"] = function () {
      return (dynCall_iiiiiiiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiiiiiiiiii"] = Module["asm"]["ya"]).apply(
        null,
        arguments
      );
    });
    var dynCall_iiiiiiiiiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiiiiiiiiii"] = function () {
      return (dynCall_iiiiiiiiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiiiiiiiiiii"] = Module["asm"]["za"]).apply(
        null,
        arguments
      );
    });
    var dynCall_iiiiiiiiiiiiiiiiiii = (Module["dynCall_iiiiiiiiiiiiiiiiiii"] = function () {
      return (dynCall_iiiiiiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiiiiiiiii"] = Module["asm"]["Aa"]).apply(
        null,
        arguments
      );
    });
...
export const BasisModule = BASIS;
